...
class InputPortofolio extends StatefulWidget {
  const InputPortofolio({super.key});

  @override
  State<InputPortofolio> createState() => _InputPortofolioState();
}

class _InputPortofolioState extends State<InputPortofolio> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Tambah Portofolio", style: GoogleFonts.lato(fontSize: 20 , fontWeight: FontWeight.w600)),
      ),
      body: Center(
